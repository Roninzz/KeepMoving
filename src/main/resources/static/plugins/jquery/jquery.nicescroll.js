...
(function(factory) {
  ...
  var NiceScrollClass = function(myopt, me) {
    ...
    this.locked = false;  // prevent lost of locked status sets by login
    this.hidden = false; // rails always hidden
    this.cursoractive = true; // login can interact with cursors
...
//      cap.cantouch = false; // parse normal desktop events
    ...
    //## disable MouseLock API on login request
