package com.keepmoving.fitness.pay.alipay.trade.model;


import com.google.gson.annotations.SerializedName;
import com.keepmoving.fitness.pay.alipay.trade.utils.Utils;
...
// 创建一个商品信息，参数含义分别为商品id（使用国标）、商品名称、商品价格（单位为分）、商品数量
    public static org.thlws.payment.alipay.trade.model.GoodsDetail newInstance(String goodsId, String goodsName, long price, int quantity) {
        org.thlws.payment.alipay.trade.model.GoodsDetail info = new org.thlws.payment.alipay.trade.model.GoodsDetail();
