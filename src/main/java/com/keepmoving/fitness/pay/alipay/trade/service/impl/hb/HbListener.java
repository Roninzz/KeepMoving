...
import com.keepmoving.fitness.pay.alipay.trade.model.hb.HbStatus;
...
public class HbListener implements TradeListener {
    private static Log log = LogFactory.getLog(org.thlws.payment.alipay.trade.service.impl.hb.HbListener.class);
